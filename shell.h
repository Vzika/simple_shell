...
/**
 *struct passinfo - contains pseudo-arg to pass into a func,
 *		allowing uniform prototype for func pointer structure
 *@arg: a str generated from getline containing args
 *@argv: an arr of str generated from arg
 ...
 *@status: the return status of the last exec'd cmd
